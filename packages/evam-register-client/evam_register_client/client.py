...
class AsyncRegisterClient:
    ...
    async def convert_lead(self, lead_id: str, *, is_lending: bool = False,
        ...
        payload = {"is_lending": is_lending, "is_syndication": is_syndication,
                   ...
                   "lending_amount_cr": lending_amount_cr, "lending_stage": lending_stage,
                   "syn_amount_cr": syn_amount_cr, "syn_type": syn_type,
                   "syn_mandate_status3": syn_mandate_status3, "syn_status": syn_status,
                   "syn_facility": syn_facility, "syn_tenor": syn_tenor,
                   "syn_priority": syn_priority, "syn_im_status": syn_im_status,
                   "syn_potential": syn_potential, "syn_existing": syn_existing,
                   "syn_price": syn_price,
