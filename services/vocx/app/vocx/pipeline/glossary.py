...
def build_known_names_block(company_names: Iterable[str] | None = None) -> str:
    ...
    lines.append(
        ...
        "in Tamil Nadu and Bihar') NEVER fill location — they belong in the "
        "requirement text, remarks and the subsector key-data fields. If the "
        "venue is not spoken, location is null.\n"
