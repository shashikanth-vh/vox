...
async def convert_lead_txn(inp: LeadConversionInput, idempotency_key: str,
    ...
    async with _client(caller) as reg:
        return await reg.convert_lead(
            ...
            lending_amount_cr=inp.lending_amount_cr, lending_stage=inp.lending_stage,
            syn_amount_cr=inp.syn_amount_cr, syn_type=inp.syn_type,
            syn_mandate_status3=inp.syn_mandate_status3, syn_status=inp.syn_status,
            syn_facility=inp.syn_facility, syn_tenor=inp.syn_tenor,
            syn_priority=inp.syn_priority, syn_im_status=inp.syn_im_status,
            syn_potential=inp.syn_potential, syn_existing=inp.syn_existing,
            syn_price=inp.syn_price,
