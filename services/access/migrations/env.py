"""Alembic environment for the Access service (sync psycopg, app settings as source)."""
...
def run_migrations_offline() -> None:
    context.configure(url=settings.alembic_dsn, target_metadata=target_metadata,
